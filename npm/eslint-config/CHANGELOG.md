...
- Remove `@types/eslint` in favor of ESLint's bundled types.

### Update

- Update `@eslint/js` to `v10.0.1`.
- Update `eslint` to `v10.9.1` and require ESLint 10.
- Update `globals` to `v17.11.0`.
...
- Update `@eslint/js` to `v9.39.5`.
- Update `eslint` to `v9.39.5`.
- Update `globals` to `v17.9.0`.
...
- Update `@eslint/compat` to `v1.4.1`.
- Update `@eslint/js` to `v9.39.0`.
- Update `eslint` to `v9.39.0`.
- Update `globals` to `16.5.0`.
...
- Update `@eslint/js` to `v9.37.0`.
- Update `eslint` to `v9.37.0`.
- Update `globals` to `v16.4.0`.
